...
export default function LeftBar() {
  ...
  return (
    <>
      ...
      {/* MOBİL: Üst Navbar */}
      <div className="lg:hidden sticky top-0 w-full bg-[#1F2937] shadow-[0_4px_12px_rgba(0,0,0,0.3)] border-b border-gray-400 flex items-center px-3 py-2 z-[1000] backdrop-blur-md">
      ...
      {/* MOBİL: Alt Navbar */}
      <div className="lg:hidden sticky bottom-0 w-full bg-[#1F2937] shadow-[0_-4px_12px_rgba(0,0,0,0.3)] border-t border-gray-400 flex justify-around items-center py-2 z-[1000] backdrop-blur-md">
        {menuList.map((item) =>
          item.link ? (
