        ...
        <div className="fixed w-screen h-screen left-0 top-0 bg-[#3E6A8A] bg-opacity-75 z-10 flex items-center justify-center">
            <div className="bg-[#FAFCF2] rounded-xl p-12 flex flex-col gap-4 shadow-lg border border-[#BDC4BF]">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button className="py-2 px-4 rounded-full bg-[#A8DBF0] text-[#3E6A8A] font-bold border border-[#3E6A8A]" 
                        onClick={onClose}>
                        Save
                    </button>
                </div>
                ...
                <div className="flex items-center justify-between text-sm text-[#3E6A8A]">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="flex items-center gap-2 cursor-pointer" onClick={()=>handleChangeType("original")}>
                            <svg width={24} viewBox="0 0 24 24">
                                <path className={settings.type === "original" ? "fill-[#3E6A8A]" : "fill-[#BDC4BF]"}
                        ...
                        <div className="flex items-center gap-2 cursor-pointer" onClick={()=>handleChangeType("wide")}>
                            <svg width={24} viewBox="0 0 24 24">
                                <path className={settings.type === "wide" ? "fill-[#3E6A8A]" : "fill-[#BDC4BF]"}
                                    d="M3 7.5C3 6.119 4.119 5 5.5 5h13C19.881 5 21 6.119 21 7.5v9c0 1.381-1.119 2.5-2.5 2.5h-13C4.119 19 3 17.881 3 16.5v-9zM5.5 7c-.276 0-.5.224-.5.5v9c0 .276.224.5.5.5h13c.276 0 .5-.224.5-.5v-9c0-.276-.224-.5-.5-.5h-13z" />
                            </svg>
                            Wide
                        </div>
                        ...
                        <div className="flex items-center gap-2 cursor-pointer" onClick={()=>handleChangeType("square")}>
                            <svg width={24} viewBox="0 0 24 24">
                                <path className={settings.type === "square" ? "fill-[#3E6A8A]" : "fill-[#BDC4BF]"}
                                    d="M3 7.5C3 6.119 4.119 5 5.5 5h13C19.881 5 21 6.119 21 7.5v9c0 1.381-1.119 2.5-2.5 2.5h-13C4.119 19 3 17.881 3 16.5v-9zM5.5 7c-.276 0-.5.224-.5.5v9c0 .276.224.5.5.5h13c.276 0 .5-.224.5-.5v-9c0-.276-.224-.5-.5-.5h-13z" />
                            </svg>
                            Square
                        </div>
                    ...
                    <div className={`cursor-pointer py-1 px-4 rounded-full text-white ${settings.sensitive ? "bg-red-500" : "bg-[#A8DBF0]"}`}
